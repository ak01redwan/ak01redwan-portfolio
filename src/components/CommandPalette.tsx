    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[15vh] bg-slate-950/60 backdrop-blur-md px-4">
      ...
      >
        <div className="flex items-center border-b border-slate-200 dark:border-slate-800 px-4">
          <Command.Input 
            autoFocus
            placeholder={t('nav.search') || "Search projects, case studies, resume or commands..."} 
        ...
        <Command.List className="max-h-[350px] overflow-y-auto p-3 scrollbar-hide">
          ...
          <Command.Group heading="Navigation" className="text-xs font-mono font-bold text-slate-400 px-2 py-2">
            <Command.Item 
          ...
          <Command.Group heading="Case Studies" className="text-xs font-mono font-bold text-slate-400 px-2 py-2 mt-2 border-t border-slate-100 dark:border-slate-800/60">
            {CASE_STUDIES.map((study) => (
              ...
              >
                ...
                <span className="text-[11px] font-mono text-slate-400">{study.category}</span>
              </Command.Item>
            ))}
          </Command.Group>

          <Command.Group heading="Settings & Actions" className="text-xs font-mono font-bold text-slate-400 px-2 py-2 mt-2 border-t border-slate-100 dark:border-slate-800/60">
            <Command.Item 
            ...
            >
              ...
              <span>Switch Language (English / العربية)</span>
            </Command.Item>
          </Command.Group>
        </Command.List>
      </Command>
